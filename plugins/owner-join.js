...
let handler = async (m, { conn, text, isOwner }) => {
    if (!text) return m.reply('👑 Debes enviar una invitacion para que *Kirito-Bot* se una al grupo.');
    ...
    if (isOwner) {
        ...
        await conn.sendMessage('50488198573' + '@s.whatsapp.net', { text: message, mentions: [m.sender] }, { quoted: m });
